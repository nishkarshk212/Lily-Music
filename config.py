...
BOT_USERNAME = getenv("BOT_USERNAME", "Saregama_212_bot")
BOT_NAME = getenv("BOT_NAME", "♪ ꜱᴀʀᴇɢᴀᴍᴀ ᴍᴜꜱɪᴄ ♪")
...
# ── External APIs ──────────────────────────────────────────────────────────────
COOKIE_URL = getenv("COOKIE_URL")  # optional (not needed if using NextGen API)
API_URL = getenv("API_URL")        # optional - NextGen API URL for audio
VIDEO_API_URL = getenv("VIDEO_API_URL")  # optional - NextGen API URL for video
API_KEY = getenv("API_KEY")        # optional - NextGen API key
DEEP_API = getenv("DEEP_API")      # optional
NEXGENBOTS_API = getenv("NEXGENBOTS_API", "https://pvtz.nexgenbots.xyz")  # NextGen API base URL
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/jayden_clan")
...
PING_VID_URL = "https://files.catbox.moe/1sz80c.mp4"
...
WELCOME_VID_URL = "https://files.catbox.moe/xnlr5s.mp4"
